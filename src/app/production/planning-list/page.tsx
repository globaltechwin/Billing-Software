      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <table className="w-full min-w-[1100px]">
            <thead>
              <tr className="bg-[#3d9a7e] text-white">
                ...
                <th className="px-3 py-3 text-center text-xs font-semibold">
                  <div className="flex items-center justify-center gap-1">PLAN NO. ↕</div>
                </th>
                <th className="px-3 py-3 text-center text-xs font-semibold">
                  <div className="flex items-center justify-center gap-1">CATEGORY ↕</div>
                </th>
                <th className="px-3 py-3 text-center text-xs font-semibold">
                  <div className="flex items-center justify-center gap-1">ENTRY DATE ↕</div>
                </th>
                <th className="px-3 py-3 text-center text-xs font-semibold">
                  <div className="flex items-center justify-center gap-1">REQUEST DATE ↕</div>
                </th>
                <th className="px-3 py-3 text-center text-xs font-semibold">
              ...
              {paginatedData.length === 0 ? (
                ...
                paginatedData.map((row) => (
                  <tr key={row.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-3 py-3 text-sm text-gray-700 text-center font-medium">{row.planNo}</td>
                    <td className="px-3 py-3 text-sm text-gray-700 text-center">{row.category}</td>
                    <td className="px-3 py-3 text-sm text-gray-700 text-center">{row.entryDate}</td>
                    <td className="px-3 py-3 text-sm text-gray-700 text-center">{row.requestDate}</td>
        ...
        <div className="px-4 py-3 border-t border-gray-200">
          <div className="text-sm text-gray-700 font-medium mb-2">
            Total: <span className="ml-2">{showData && filteredData.length > 0 ? "0.00" : "0.00"}</span>
          </div>
        </div>
