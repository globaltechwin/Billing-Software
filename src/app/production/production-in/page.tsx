...
export default function ProductionInPage() {
  const [productionCategory, setProductionCategory] = useState("");
  const [productionTransferNo, setProductionTransferNo] = useState("");
  const [planningNo, setPlanningNo] = useState("");
  const [indentNo, setIndentNo] = useState("");
  const [productSearch, setProductSearch] = useState("");
  const [showProductDropdown, setShowProductDropdown] = useState(false);
  const [remarks, setRemarks] = useState("");
  const [items, setItems] = useState<ProductionInItem[]>([]);
  ...
  const handleProductSelect = (product: (typeof sampleProducts)[0]) => {
    ...
    if (exists) {
      ...
      const newItem: ProductionInItem = {
        id: String(Date.now()),
  ...
  const handleSave = () => {
    ...
    alert("Production-In saved successfully!");
    handleClear();
  };

  const handleClear = () => {
    setProductionCategory("");
    setProductionTransferNo("");
    setPlanningNo("");
    setIndentNo("");
    setProductSearch("");
    setRemarks("");
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-800">Production-In</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-2">
                <label className="text-sm font-medium text-gray-700 whitespace-nowrap">Production Transfer No.</label>
                <div className="relative">
                  <input
                    type="text"
                    value={productionTransferNo}
                    onChange={(e) => setProductionTransferNo(e.target.value)}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm font-medium text-gray-700 whitespace-nowrap">Planning No.</label>
                <div className="relative">
                  <input
                    type="text"
                    value={planningNo}
