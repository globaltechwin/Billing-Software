...
export default function ComplimentBillReportPage() {
  ...
  const [reportData, setReportData] = useState<ComplimentBillRow[]>([]);
    ...
    if (searchQuery) {
      ...
      data = data.filter(
        (r) =>
          ...
          r.createdByBy.toLowerCase().includes(q)
      );
    }
    return data;
    ...
    <div className="flex flex-col h-full p-4 gap-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 flex flex-wrap items-center gap-3">
          <span className="text-sm font-semibold text-gray-800">Compliment Bill Report</span>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <table className="w-full min-w-[1100px]">
            <thead>
              <tr className="bg-[#3d9a7e] text-white">
                ...
                <th className="px-4 py-3 text-center text-xs font-semibold">SUB TOTAL</th>
                ...
                <th className="px-4 py-3 text-center text-xs font-semibold">CREATEDBY BY</th>
                <th className="px-4 py-3 text-center text-xs font-semibold">CREATED DATE</th>
                <th className="px-4 py-3 text-center text-xs font-semibold">BILLID1</th>
                <th className="px-4 py-3 text-center text-xs font-semibold">EDIT</th>
              </tr>
            </thead>
            <tbody>
              {paginatedData.length === 0 ? (
                ...
                paginatedData.map((row) => (
                  <tr key={row.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-700 text-center">{row.subTotal.toFixed(2)}</td>
                    ...
                    <td className="px-4 py-3 text-sm text-gray-700 text-center">{row.createdByBy}</td>
                    <td className="px-4 py-3 text-sm text-gray-700 text-center">{row.createdDate}</td>
                    <td className="px-4 py-3 text-sm text-gray-700 text-center">{row.billId1}</td>
        ...
        <div className="px-4 py-3 border-t border-gray-200 bg-gray-50">
          <div className="flex items-center justify-start gap-8 pl-4">
            ...
            <span className="text-sm font-semibold text-gray-800 min-w-[80px] text-center">{reportData.length > 0 ? totals.subTotal.toFixed(2) : "0.00"}</span>
          </div>
        </div>
